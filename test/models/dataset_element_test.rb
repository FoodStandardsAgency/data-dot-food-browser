  ...
  class DatasetElementTest < ActiveSupport::TestCase
    let :element_fixture do
      VCR.use_cassette('load_dataset_element') do
        api = CatalogApi.new
        api.dataset_element('c27423b7-775c-4220-a626-638fecd409a7/element/57bee23ec56bb56904388aad33176a5d') # rubocop:disable Metrcis/LineLength
      end
    end
    ...
    it 'should return the years on request' do
      d = DatasetElement.new({ startDate: '2016-01-01', endDate: '2016-03-01' }, nil)
      d.years.sort.must_equal [2016]

      d = DatasetElement.new({ startDate: '2015-01-01', endDate: '2016-03-01' }, nil)
    ...
    it 'should always return a sort key' do
      k = DatasetElement.new({ startDate: '2016-01-01', endDate: '2016-03-01' }, nil).sort_key
